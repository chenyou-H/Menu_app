...
public class changeItem implements ComponentListener {
	JFrame jf;
	JButton b1;
	JButton back;
//	JButton addMore;
...
//	JTextField cateTF;
	...
	changeItem(String restInfor,String itemInfor){	
...
//		cateTF = new JTextField();
		...
		String itemInfor2 = itemInfor.substring(itemInfor.indexOf(" ")+1);
		category = new JLabel(itemInfor2);
		DB = new JDBC();
...
//		jf.add(addMore);
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					DB.updateFood(itemID, foodNameTF.getText(), descriptionTF.getText(), priceTF.getText(), sizeTF.getText());
	...
	public void componentResized(ComponentEvent e) {
		...
		category.setBounds(jf.getWidth()/20, jf.getHeight()/10,jf.getWidth() , jf.getHeight()/15);	
	}
